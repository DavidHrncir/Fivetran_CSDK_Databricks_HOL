...
5. You will be prompted to enter your source code path. Click the folder icon. You should be directly at the **phr** folder. Click the **phr** folder. If by chance this is not the default, simply choose **Workspace, Users, [your login], phr**. <ins>Note that you should see the 3 files we created earlier.</ins>
