...
<div style="display:flex; align-items:center; margin-bottom:15px">
    ...
    <div>
        ...
        <p style="font-size:1.1rem; color:gray; margin:0; padding:0">Fivetran and Databricks-powered Streamlit data application for Financial Services</p>
    </div>
</div>
''', unsafe_allow_html=True)
...
UC_SCHEMA = os.environ.get("UC_SCHEMA", "fpr_connector_dbx")
UC_TABLE = os.environ.get("UC_TABLE", "fpr_records")
    ...
    try:
        ...
        payload = {
            "messages": [
                {
                    "role": "system",
                    "content": "You are a financial services analytics expert analyzing financial product recommendation data. Provide clear, evidence-based analysis with actionable insights for retail banking teams, product managers, and customer experience teams."
                },
                {
                    "role": "user",
                    "content": prompt
            ...
            if insights:
                ...
                with st.expander(f"📋 Generated {focus_area} Report (Real Financial Services Data)", expanded=True):
                    ...
                    <div class="agent-report-header">
                        ...
                        <small>Data Source: Live Databricks Banking Analysis</small><br>
