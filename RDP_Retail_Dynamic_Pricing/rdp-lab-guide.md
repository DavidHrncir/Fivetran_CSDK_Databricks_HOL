# Fivetran Connector SDK Hands on Lab with Databricks 2025: Retail Dynamic Pricing
...
5. You will be prompted to enter your source code path. Click the folder icon. You should be directly at the **rdp** folder. Click the **rdp** folder. If by chance this is not the default, simply choose **Workspace, Users, [your login], rdp**. <ins>Note that you should see the 3 files we created earlier.</ins>
