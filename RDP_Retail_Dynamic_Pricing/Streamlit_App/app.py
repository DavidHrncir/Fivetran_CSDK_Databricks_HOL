...
<div style="display:flex; align-items:center; margin-bottom:15px">
    ...
    <div>
        ...
        <p style="font-size:1.1rem; color:gray; margin:0; padding:0">Fivetran and Databricks-powered Streamlit data application for Retail</p>
    </div>
</div>
''', unsafe_allow_html=True)
...
UC_SCHEMA = os.environ.get("UC_SCHEMA", "rdp_connector_dbx")
UC_TABLE = os.environ.get("UC_TABLE", "rdp_records")
    ...
    try:
        ...
        payload = {
            "messages": [
                {
                    "role": "system",
                    "content": "You are a retail pricing analytics expert analyzing dynamic pricing data. Provide clear, evidence-based analysis with actionable insights for pricing managers, inventory teams, and retail executives."
                },
                {
                    "role": "user",
                    "content": prompt
...
def generate_insights(data, focus_area, model_name):
    ...
    numeric_stats = {}
    key_metrics = ["order_total", "product_price", "inventory_level", "customer_lifetime_value", "order_frequency", "average_order_value", "product_rating", "product_review_count", "price_elasticity", "demand_forecast", "inventory_turnover", "stockout_rate", "overstock_rate", "revenue_growth_rate", "customer_satisfaction_rate"]
...
numeric_cols = [col for col in ["order_total", "product_price", "inventory_level", "customer_lifetime_value", "order_frequency", "average_order_value", "product_rating", "product_review_count", "price_elasticity", "demand_forecast", "inventory_turnover", "stockout_rate", "overstock_rate", "revenue_growth_rate", "customer_satisfaction_rate"] if col in data.columns]
            ...
            if insights:
                ...
                with st.expander(f"📋 Generated {focus_area} Report (Real Retail Dynamic Pricing Data)", expanded=True):
                    ...
                    <div class="agent-report-header">
                        ...
                        <small>Data Source: Live Databricks Retail Pricing Analysis</small><br>
