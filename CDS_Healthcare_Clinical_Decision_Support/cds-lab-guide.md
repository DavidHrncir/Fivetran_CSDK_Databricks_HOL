# Fivetran Connector SDK Hands on Lab with Databricks 2025: Healthcare Clinical Decision Support
...
5. For the **App name** field, enter an app name that is unique such as [initials][birth month][birthday][cds]-app. ex. **dh0816cds-app** The **Description** can be left blank.
...
5. Enter this vertical's abbreviation, **cds**, as the name of the folder and click **Create**.
6. This folder will automatically become the current folder as you will see at the top of the screen now states **cds**.

### 4.3 Create Empty File Placeholders In Your Workspace Folder
In the **cds** folder you just created, create 3 empty files by either right-clicking or using the **Create** button in the upper right for the first file. <ins>Once the first file is created, you can simply click the **+** sign in the tabbed view to create new files.</ins>
   - **app.py**
   - **app.yaml**
   - **requirements.txt**
...
5. You will be prompted to enter your source code path. Click the folder icon. You should be directly at the **cds** folder. Click the **cds** folder. If by chance this is not the default, simply choose **Workspace, Users, [your login], cds**. <ins>Note that you should see the 3 files we created earlier.</ins>
