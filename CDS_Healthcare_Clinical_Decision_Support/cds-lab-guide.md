...
5. You will be prompted to enter your source code path. Click the icon. You should be directly at the **cds** folder. Click the **cds** folder. If by chance this is not the default, simply choose **Workspace, Users, [your login], cds**. <ins>Note that you should see the 3 files we created earlier.</ins>
