...
<div style="display:flex; align-items:center; margin-bottom:15px">
    ...
    <div>
        ...
        <p style="font-size:1.1rem; color:gray; margin:0; padding:0">Fivetran and Databricks-powered Streamlit data application for Manufacturing</p>
    </div>
</div>
''', unsafe_allow_html=True)
...
UC_SCHEMA = os.environ.get("UC_SCHEMA", "mso_connector_dbx")
UC_TABLE = os.environ.get("UC_TABLE", "mso_records")
    ...
    try:
        ...
        payload = {
            "messages": [
                {
                    "role": "system",
                    "content": "You are a manufacturing analytics expert analyzing material selection and optimization data. Provide clear, evidence-based analysis with actionable insights for product designers, materials engineers, and manufacturing teams."
                },
                {
                    "role": "user",
                    "content": prompt
            ...
            if insights:
                ...
                with st.expander(f"📋 Generated {focus_area} Report (Real Manufacturing Material Data)", expanded=True):
                    ...
                    <div class="agent-report-header">
                        ...
                        <small>Data Source: Live Databricks Material Optimization Analysis</small><br>
