# Fivetran Connector SDK Hands on Lab with Databricks 2025: Agriculture Livestock Health Monitoring
...
5. You will be prompted to enter your source code path. Click the folder icon. You should be directly at the **agr** folder. Click the **agr** folder. If by chance this is not the default, simply choose **Workspace, Users, [your login], agr**. <ins>Note that you should see the 3 files we created earlier.</ins>
