...
<div style="display:flex; align-items:center; margin-bottom:15px">
    ...
    <div>
        ...
        <p style="font-size:1.1rem; color:gray; margin:0; padding:0">Fivetran and Databricks-powered Streamlit data application for Insurance</p>
    </div>
</div>
''', unsafe_allow_html=True)
...
UC_SCHEMA = os.environ.get("UC_SCHEMA", "icp_connector_dbx")
UC_TABLE = os.environ.get("UC_TABLE", "icp_records")
    ...
    try:
        ...
        payload = {
            "messages": [
                {
                    "role": "system",
                    "content": "You are an insurance analytics expert analyzing claims processing data. Provide clear, evidence-based analysis with actionable insights for claims managers, underwriters, and insurance operations teams."
                },
                {
                    "role": "user",
                    "content": prompt
            ...
            if insights:
                ...
                with st.expander(f"📋 Generated {focus_area} Report (Real Insurance Claims Data)", expanded=True):
                    ...
                    <div class="agent-report-header">
                        ...
                        <small>Data Source: Live Databricks Claims Processing Analysis</small><br>
