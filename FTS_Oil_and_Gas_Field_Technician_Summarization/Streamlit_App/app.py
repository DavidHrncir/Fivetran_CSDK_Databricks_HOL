...
<div style="display:flex; align-items:center; margin-bottom:15px">
    ...
    <div>
        ...
        <p style="font-size:1.1rem; color:gray; margin:0; padding:0">Fivetran and Databricks-powered Streamlit data application for Oil & Gas</p>
    </div>
</div>
''', unsafe_allow_html=True)

# Retrieve credentials from environment variables (or use defaults for app resources)
DATABRICKS_HOST = os.environ.get("DATABRICKS_HOST", "")
DATABRICKS_HTTP_PATH = os.environ.get("DATABRICKS_SQL_HTTP_PATH", "")
DATABRICKS_TOKEN = os.environ.get("DATABRICKS_TOKEN", "")

# Define Unity Catalog and Serving Endpoints from app resources
UC_CATALOG = "ts-catalog-demo"
UC_SCHEMA = "fts_connector_dbx"
UC_TABLE = "fts_records"
    ...
    try:
        ...
        payload = {
            "messages": [
                {
                    "role": "system",
                    "content": "You are an oil and gas field operations expert analyzing field technician log summarization data. Provide clear, evidence-based analysis with actionable insights for field technicians, maintenance managers, and operations teams."
                },
                {
                    "role": "user",
                    "content": prompt
            ...
            if insights:
                ...
                with st.expander(f"📋 Generated {focus_area} Report (Real Oil & Gas Field Data)", expanded=True):
                    ...
                    <div class="agent-report-header">
                        ...
                        <small>Data Source: Live Databricks Field Operations Analysis</small><br>
