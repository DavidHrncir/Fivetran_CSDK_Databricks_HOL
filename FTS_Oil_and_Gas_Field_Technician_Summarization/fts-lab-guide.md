# Fivetran Connector SDK Hands on Lab with Databricks 2025: Oil and Gas Field Technician Summarization
...
5. You will be prompted to enter your source code path. Click the folder icon. You should be directly at the **fts** folder. Click the **fts** folder. If by chance this is not the default, simply choose **Workspace, Users, [your login], fts**. <ins>Note that you should see the 3 files we created earlier.</ins>
