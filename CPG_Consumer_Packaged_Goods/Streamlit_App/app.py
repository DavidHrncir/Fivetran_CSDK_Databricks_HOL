...
<div style="display:flex; align-items:center; margin-bottom:15px">
    ...
    <div>
        ...
        <p style="font-size:1.1rem; color:gray; margin:0; padding:0">Fivetran and Databricks-powered Streamlit data application for CPG</p>
    </div>
</div>
''', unsafe_allow_html=True)
...
UC_SCHEMA = os.environ.get("UC_SCHEMA", "cpg_connector_dbx")
UC_TABLE = os.environ.get("UC_TABLE", "cpg_records")
    ...
    try:
        ...
        payload = {
            "messages": [
                {
                    "role": "system",
                    "content": "You are a consumer insights expert analyzing CPG data. Provide clear, evidence-based analysis with actionable insights for product development teams, marketing teams, and sales teams."
                },
                {
                    "role": "user",
                    "content": prompt
...
def generate_insights_with_agent_workflow(data, focus_area, model_name, progress_placeholder=None):
    ...
    try:
        ...
        key_metrics = ["customer_satisfaction_rate", "revenue_growth_rate", "product_rating", "stockout_rate", "inventory_turnover"]
...
def generate_insights(data, focus_area, model_name):
    ...
    key_metrics = ["customer_satisfaction_rate", "revenue_growth_rate", "product_rating", "stockout_rate", 
                  "inventory_turnover", "overstock_rate", "price_elasticity", "customer_ltv", 
                  "average_order_value", "order_total", "order_frequency"]
    ...
    categorical_options = ["customer_id", "product_id", "order_id", "product_category", "product_subcategory", 
                          "customer_segment", "order_status", "price_optimization_result", 
                          "price_optimization_recommendation", "order_date", "price_optimization_date"]
            ...
            if insights:
                ...
                with st.expander(f"📋 Generated {focus_area} Report (Real CPG Consumer Data)", expanded=True):
                    ...
                    <div class="agent-report-header">
                        ...
                        <small>Data Source: Live Databricks Consumer Insights Analysis</small><br>
